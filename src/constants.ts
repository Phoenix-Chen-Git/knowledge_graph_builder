...
export const BUILTIN_CHAT_MODELS: CustomModel[] = [
  ...
  {
    name: ChatModels.GEMINI_3_FLASH,
    provider: ChatModelProviders.GOOGLE,
    enabled: true,
    isBuiltIn: true,
    core: true,
  ...
  {
    name: ChatModels.CLAUDE_35_SONNET,
    provider: ChatModelProviders.ANTHROPIC,
    enabled: true,
    isBuiltIn: true,
    capabilities: [ModelCapability.VISION, ModelCapability.REASONING],
  ...
  {
    name: ChatModels.CLAUDE_35_HAIKU,
    provider: ChatModelProviders.ANTHROPIC,
    enabled: true,
    isBuiltIn: true,
    capabilities: [ModelCapability.VISION],
...
export const ProviderInfo: Record<Provider, ProviderMetadata> = {
  [ChatModelProviders.OPENROUTERAI]: {
    ...
    testModel: ChatModels.GPT_41_mini,
  },
...
export const DEFAULT_SETTINGS: CopilotSettings = {
  ...
  defaultModelKey: ChatModels.GEMINI_FLASH + "|" + ChatModelProviders.GOOGLE,
